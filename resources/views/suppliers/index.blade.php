...
@section('header') Location @endsection
@section('description') This page about your all Location @endsection
...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            <a onclick="addForm()" class="btn btn-primary" >Add Location</a>
